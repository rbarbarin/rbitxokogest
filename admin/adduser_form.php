<h2>ADD USER</h2>                 
          <form action="adduser.php" class="form-horizontal">
            ...
            <div class="form-group">  
              ...
              <input type="text" id="email" name="email" class="col-md-6" placeholder="e-mail">
            </div>
            <div class="form-group">  
            ...
            <div class="form-group">  
              ...
              <input type="radio" name="rol_id" value="1"> Administrator 
              <input type="radio" name="rol_id" value="2"> User
            </div>
